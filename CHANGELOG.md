...
- `Models\Entry` no longer overrides `$slugTargetAttribute`, which the CMS bundle removed along with the entry
  slug columns; uniqueness is scoped through `Permalink::$uriTargetAttribute` instead
